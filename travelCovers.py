...
def buildCoverPages(w, h, year):
   ...
   # Draw image, covering all page, scaled.
    context.image('docs/images/IMG_2971-50.jpg', (-1, -10), w=w*1.2, h=h*1.045)
    ...
    coverTitleStyle = dict(font='Upgrade-Hairline', fontSize=100, textFill=1)
    bs = context.newString(magazineTitle1, style=coverTitleStyle)  
    tw, th = bs.size()  
